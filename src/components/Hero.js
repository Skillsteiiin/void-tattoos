    ...
    <motion.div
     variants={container}
      ...
      <div className='text-white text-center lg:text-left lg:max-w-[640px]'>
        ...
        <motion.p 
        variants={fadeIn('down')}
        className='mb-[32px] lg:mb-[64px] max-w-[512px] leading-relaxed'>{subtitle}</motion.p>
      ...
      {/* { outline text } */}
      <div className='hidden xl:flex absolute -bottom-[8px] right-0 left-0 before:content-outlineText'></div>
    </motion.div>
  </section>
};
